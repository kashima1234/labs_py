...
for i in steps:
    ...
    if(abs(y) >= 1e4): 
        ...
        print('{: ^18.4f}|'.format(y))                   # 18 for distance between nfirst part from first part 
...
for i in steps: 
    print('{: ^10.2f}|'.format(i), end='')      #this is for distancein first ...
...
'''
Hey God, i hope that you can take my life today, i get tired from this life 
i cant take it anymore honstely everything get hard for me
this life is bigger than me i hope that i can disappear from this life 
this is my biggest wish i hope that you can help me in this 
