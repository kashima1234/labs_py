...
def main():
    ...
    def about():
        messagebox.showinfo("About", "3rd Base Calculator by Dimitry\n@All right's reserved by creator!")
    ...
    def fourth_decimal():
        ...
        if not isit_num(A):
            ...
            entry_box.delete(0, END)
        elif ('4' in A) or ('5' in A) or ('6' in A) or ('7' in A) or ('8' in A) or ('9' in A):
            ...
            for i in range(len(chars[0])-1, -1, -1):
                m += 1
                result += chars[0][i]*(4**m)
            m = 0
            for i in range(len(chars[1])):
                m -= 1
                result += chars[1][i]*(4**m)
    ...
    filemenu.add_command(label="Fourth Base", command=decimal_fourth)
    filemenu.add_command(label="Decimal", command=fourth_decimal)
    ...
    btn_third = ttk.Button(text = "Fourth Base", command = decimal_fourth,style='e.TButton')
    ...
    btn_decimal = ttk.Button(text = "Decimal", command = fourth_decimal,style='e.TButton')
