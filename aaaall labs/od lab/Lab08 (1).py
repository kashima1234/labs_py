...
def menu():
    ...
    print('[6] Most repeating elements ')
    print('[7] Swap the lines with the most and least number if negative elements')
    print('[8] Row with minimal difference between the absolutes of sums of negative and positive elements ')
    print('[9] Swap the columns with the maximum and minimum sum of elements  ')
