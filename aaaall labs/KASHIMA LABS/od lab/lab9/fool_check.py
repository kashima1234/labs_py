# A function that returns a numeric value 
# if the argument can be represented as a number, otherwise - None
...
# if the argument can be represented as an integer, otherwise - None
